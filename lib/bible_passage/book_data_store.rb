module BiblePassage
  ...
  class BookDataStore
    ...
    BOOK_DATA = {
      ...
      jer: {
        name: 'Jeremiah',
        chapters: [19, 37, 25, 31, 31, 30, 34, 23, 26, 25, 23, 17, 27, 22, 21, 21, 27, 23, 15, 18, 14, 30, 40, 10, 38, 27, 22, 17, 32, 24, 40, 44, 26, 22, 19, 32, 21, 28, 18, 16, 18, 22, 13, 30, 5, 28, 7, 47, 39, 46, 64, 34]
      },
      lam: {
        name: 'Lamentations',
