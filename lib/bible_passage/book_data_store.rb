module BiblePassage
  ...
  class BookDataStore
    ...
    BOOK_DATA = {
      ...
      num: {
        name: 'Numbers',
        chapters: [54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16, 33, 45, 41, 40, 28, 32, 22, 29, 35, 41, 30, 25, 19, 65, 23, 31, 39, 17, 54, 42, 56, 29, 34, 13],
      },
      deut: {
        name: 'Deuteronomy',
        chapters: [46, 37, 29, 49, 33, 25, 26, 20, 29, 22, 32, 31, 19, 29, 23, 22, 20, 22, 21, 20, 23, 30, 26, 22, 19, 19, 26, 69, 28, 20, 30, 52, 29, 12]
      },
      josh: {
        name: 'Joshua',
      ...
      '1sam'.to_sym => {
        name: '1 Samuel',
        chapters: [28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 42, 16, 23, 29, 23, 43, 25, 12, 25, 11, 31, 13]
      },
      '2sam'.to_sym => {
        name: '2 Samuel',
      ...
      '1kings'.to_sym => {
        name: '1 Kings',
        chapters: [53, 46, 28, 34, 32, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 43, 29, 54]
      },
      '2kings'.to_sym => {
        name: '2 Kings',
      ...
      isa: {
        name: 'Isaiah',
        chapters: [31, 22, 26, 6, 30, 13, 25, 23, 21, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17, 25, 18, 23, 12, 21, 13, 29, 24, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29, 25, 28, 28, 25, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13, 12, 21, 14, 21, 22, 11, 12, 19, 11, 25, 24]
      },
      jer: {
        name: 'Jeremiah',
        chapters: [19, 37, 25, 31, 31, 30, 34, 23, 26, 25, 23, 17, 27, 22, 21, 21, 27, 23, 15, 18, 14, 30, 40, 10, 38, 24, 22, 17, 32, 24, 40, 44, 26, 22, 19, 32, 21, 28, 18, 16, 18, 22, 13, 30, 5, 28, 7, 47, 39, 46, 64, 34]
      },
      lam: {
        name: 'Lamentations',
